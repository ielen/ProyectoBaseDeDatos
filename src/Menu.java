        ...
        while (opcion != 4) {
            ...
            switch (opcion) {
                case 1:
                    ...
                    try {
                        PreparedStatement insert = conn.prepareStatement(insert1, PreparedStatement.RETURN_GENERATED_KEYS);
                        ...
                        if (tipoEmPer == 1) {
                            ...
                            insertarPersona.setInt(2, id_usuario);
                            ...
                            insertarEmpresa.setInt(2, id_usuario);
